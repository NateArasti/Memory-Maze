public class SigmaMazeGenerator : MazeGenerator
{
	public SigmaMazeGenerator() :
		base(MazeCharacteristics.Characteristics[MazeType.SigmaMaze].paramValues[0] * 2 - 1,
			MazeCharacteristics.Characteristics[MazeType.SigmaMaze].paramValues[0] * 2 - 1)
	{
	}
	...
	{
		for (var j = 0; j < cellArray.Length; j++) cellArray[j] = new SigmaMazeCell();
	}
}